<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="infoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="信息编号" align="center" prop="infoId" />
      <el-table-column label="信息内容" align="center" prop="infoContent" />
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除公告信息编号为"' + _infoIds + '"的数据项？').then(function() {
